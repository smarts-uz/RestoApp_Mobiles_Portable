    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-itema ctive"><a href="{!! route('slides.index') !!}">{{trans('lang.slide_plural')}}</a>
          </li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{!! route('slides.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.slide_create')}}</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
      <div class="row">
        ...
        <div class="form-group col-12 text-right">
          <a href="{!! route('slides.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.back')}}</a>
        </div>
      </div>
